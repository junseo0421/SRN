...
if __name__ == '__main__':
    ...
    TEST_DATA_DIR='datasets/t1_kj_CROP_W25P'
    LOAD_WEIGHT_DIR = 'outpainting/checkpoints/HKPU_B/Gen_former_800.pt'
    SAVE_DIR = 'outpainting/test_result/HKPU_B_TEST/'
    ...
    config['TYPE'] = 'swin_cross_attn_ResB'
    config['IMG_SIZE'] = 224
    ...
    gen.load_state_dict(torch.load(args.load_weight_dir))

    ## 2023 11 09 test dataload
    ...
    if args.rand_pair:
        ...
        eval_data = dataset_test4(root=args.test_data_dir, transforms=transformations,
                                  imgSize=192, inputsize=input_size[times-1], pred_step=pred_step, imglist=tds)
