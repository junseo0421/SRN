...
class FAM_KD(nn.Module):
    def __init__(self, student, teacher):
        ...
        self.shapes = [24, 48, 96, 192]
        self.out_shapes = [24, 48, 96, 192]
    ...
    def forward_train(self, features_student, features_teacher):
        # get features
...
class CROSSATF(nn.Module):
    def __init__(self, in_channel, mid_channel, out_channel, fuse, shape, out_shape):
