...
if __name__ == '__main__':
    NAME_DATASET = 'HKdb-1'
    SAVE_BASE_DIR = r'D:\DION4FR\dq_u_net_sep4\output'
    ...
    def get_args():
        ...
        #SRN
        parser.add_argument('--pretrained_network', type=int, default=1, help="1: to pretrain network, 0: to finetune network")
        parser.add_argument('--img_shapes', nargs='+', default=[192, 192, 3])
        parser.add_argument('--mask_shapes', nargs='+', default=[192, 128])
        parser.add_argument('--batch_size', type=int, default=8)
        parser.add_argument('--feat_expansion_op', type=str, default='subpixel')
        parser.add_argument('--use_cn', type=int, default=1)
        parser.add_argument('--g_cnum', type=int, default=64)
        parser.add_argument('--d_cnum', type=int, default=64)
        parser.add_argument('--gan_loss_alpha', type=float, default=1e-3)
        parser.add_argument('--wgan_gp_lambda', type=float, default=10)
        parser.add_argument('--pretrain_l1_alpha', type=float, default=1.2)
        parser.add_argument('--l1_loss_alpha', type=float, default=5)
        parser.add_argument('--ae_loss_alpha', type=float, default=1.2)
        parser.add_argument('--mrf_alpha', type=float, default=0.05)
        parser.add_argument('--fa_alpha', type=float, default=0.5)
        parser.add_argument('--lrG', type=float, default=1e-4)
        parser.add_argument('--lrD', type=float, default=1e-4)
        parser.add_argument('--lpG', type=int, default=1)
        parser.add_argument('--lpD', type=int, default=5)
        parser.add_argument('--beta1', type=float, default=.9)
        parser.add_argument('--beta2', type=float, default=.999)
        parser.add_argument('--l1_type', type=int, default=0)
        parser.add_argument('--random_mask', type=int, default=1)
        parser.add_argument('--max_delta_shapes', nargs='+', default=[0, 0])
        parser.add_argument('--margins', nargs='+', default=[0, 0])
        parser.add_argument('--summarydir', type=str, default='log/store')
    ...
    # gen = V_Thin_Sep_UNet_4(n_channels=3, n_classes=3).cuda()
